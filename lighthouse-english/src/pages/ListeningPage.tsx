...
export function ListeningPage() {
  ...
  const { addPoints, userData, PET_FACES } = useUserData();
  ...
  const initializeGame = useCallback(() => {
    ...
    const selectedQuestions = pickRandom(allQuestions, 8);
    
    const cardPairs: Card[] = selectedQuestions.flatMap((q, index) => [
      { id: `${index}-a`, word: q.word, image: q.image, isFlipped: false, isMatched: false },
      { id: `${index}-b`, word: q.word, image: q.image, isFlipped: false, isMatched: false },
    ]);
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary-50 to-orange-100 pb-8">
        ...
        <div className="max-w-4xl mx-auto px-4 mt-8">
          <div className="bg-white rounded-2xl p-6 shadow-warm-lg text-center">
            ...
            <p className="text-gray-600 mb-4">你成功配对了所有单词！</p>
      ...
      <div className="max-w-4xl mx-auto px-4 mt-4">
        ...
        <div className="mt-4 bg-white rounded-2xl p-6 shadow-warm">
          <div className="text-center mb-6">
            <p className="text-gray-600">点击卡片翻转，找到配对的单词</p>
          </div>
              ...
              >
                {card.isFlipped || card.isMatched ? (
                  <>
                    ...
                    <span className="text-xs font-medium text-gray-700">{card.word}</span>
                  </>
                ) : (
