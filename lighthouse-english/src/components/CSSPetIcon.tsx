...
const PET_IMAGE_MODULES = import.meta.glob('../../image/*', {
  eager: true,
  query: '?url',
  import: 'default',
...
export function CSSPetIcon({
  ...
  const imageSrc = getPetLevelImage(type, level);
    ...
    return (
      ...
      >
        ...
        <img
          ...
          className="relative z-10 w-full h-full object-contain select-none drop-shadow-xl"
          draggable={false}
        />
      </div>
    );
